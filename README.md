...
## 6. 회고 / 느낀점
- 아쉬웠던 점이 많았던 프로젝트였다. 첫 번째, 초반 요구사항 설계나 역할분담과 같은 초기 작업이 제대로 이루어지지 못한 점,
  두 번째, 하나의 자바 파일에 두 사람 이상의 코드가 합쳐지며 나중에 가서 통합 작업이 오래 걸리고 힘들었다는 점이다.
  결과적으로 불필요한 과정을 몇 번 더 거쳐 기능이나 화면의 업그레이드가 부족했던 프로젝트였다.
  그러나 이런 과정을 겪으며 팀원 간의 커뮤니케이션이나 초기 기획/설계 단계의 중요성 등을 더욱 느낄 수 있었으며
  게시판의 기본 기능을 구현하며 공부했던 것을 다시 되돌아보는 시간을 가질 수 있어 좋은 경험이었다고 생각한다.
<br>
